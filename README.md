...
* [Створення IoT-приладу](blob/Iot.md)
* [Відправлення запиту POST з фото на сервер](blob/Post.md)
* [Стверення бази даних PostgreSQL](blob/Postgresql.md)
* [Заповення бази даних JSON-файлами](Json.md)
* [Створення RESTful сервера](blob/Server.md)
* [Написання програми для обробки фотографії перед розпізнаванням](../blob/Crop.md)
* [Створення Дата сету](../Dataset.md)
* [Створення нейронної мережі для розпізнавання](blob/Recognition.md)
